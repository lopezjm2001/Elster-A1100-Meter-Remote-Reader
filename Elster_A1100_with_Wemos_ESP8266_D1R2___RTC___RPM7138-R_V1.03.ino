...
/**
  ...
  ***********************************************************************************
  ...
  1. Added cache to 2x digital input interrupts.
  2. Added function to set time and date of RTC by using the serial connection.
  To set the RTC clock use the serial monitor.
       Enter T1124154091014; then select "SEND" the code will read this and set the RTC.
       T(sec)(min)(hour)(dayOfWeek)(dayOfMonth)(month)(year)
       T(00-59)(00-59)(00-23)(1-7)(01-31)(01-12)(00-99)
       Example: 02-Feb-09 @ 19:57:11 for the 3rd day of the week -> T1157193020209 
  ***********************************************************************************
*/
// IMPORTANT: The RPM7138-R is a sensitive device so be carefull of static, heat and scratching the lense.

#include <ESP8266WiFi.h>
#include <SPI.h>
#include <TimeLib.h>
#include <DS1307RTC.h>
#include <Wire.h>          //Set RTC

const char ssid[] = "DODO-1D53";
const char pass[] = "J8RHUYVZDA";
...
#define BUFF_SIZE 64
#define DS3231_I2C_ADDRESS 104    //Set RTC
...
//--------------------------------------------------------------------------------------------------------------------
  ...
  void ICACHE_RAM_ATTR onPulse();           // Create cache for interrupt

//--------------------------------------------------------------------------------------------------------------------

  void ICACHE_RAM_ATTR onPulseRPM7138();    // Create cache for interrupt
...
void watchConsole()
{
  if (Serial.available()) {      // Look for char in serial queue and process if found
    if (Serial.read() == 84) {      //If command = "T" Set Date
      ...
      if (dbug) Serial.println("Old Date and Time: ");
      get3231Date();
      set3231Date();
      if (dbug) Serial.println("New Date and Time: ");
      readRTC();
      digitalClockDisplay();
      sei();    //enable interrupts
    }
...
void set3231Date()
{
//T(sec)(min)(hour)(dayOfWeek)(dayOfMonth)(month)(year)   T0046202
//T(00-59)(00-59)(00-23)(1-7)(01-31)(01-12)(00-99)
//Example: 02-Feb-09 @ 19:57:11 for the 3rd day of the week -> T0040221041119
// T1124154091014
...
void get3231Date()
{
  // send request to receive data starting at register
  byte seconds, minutes, hours, day, date, month, year;
  char weekDay[4]; //Set RTC
  ...
  if (dbug){
            Serial.print("Day: "); Serial.println(weekDay); Serial.print("DATE: "); Serial.print(date, DEC); Serial.print("/"); Serial.print(month, DEC); Serial.print("/"); Serial.println(year, DEC);
